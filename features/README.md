...
| 003 | [run-to-completion](003-run-to-completion/) | Stage 3: `plan.md` written, four PRs; intent gate [#76](https://github.com/nimeshjm/blog-research-agent/issues/76) closed `COMPLETED`, `spec.md` merged. The Stage 2 measurement lives at [`probe/`](../probe/FINDINGS.md). Tracking [#75](https://github.com/nimeshjm/blog-research-agent/issues/75). [Open issues](https://github.com/nimeshjm/blog-research-agent/issues?q=is%3Aissue+is%3Aopen+label%3Afeature%3A003) |
